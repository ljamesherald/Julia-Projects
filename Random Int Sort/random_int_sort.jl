...
println(random_array_for_selection_sort)
# this fuction prints the total time it took to declare, and populate the array
println("time to bubble sort array: ", run_time_after_selection_sort - run_time_before_selection_sort, " ns")
println()
